  ...
  <div id="content">
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/administration/campaign/mailers/" title="Campaign">Mailers</a></li>
	...
	<div class="inner"> 
      <h2>{$campaignData._campaign_title}</h2>
    ...
    <div id="sidetabs">
        <ul >             
			...
			<li><a href="/administration/campaign/mailers/comms.php?code={$campaignData._campaign_code}" title="Details">Comms</a></li>
        </ul>
    </div><!--tabs-->	
	...
	<br />
	<form id="detailsForm" name="detailsForm" action="/administration/campaign/mailers/mail.php?code={$campaignData._campaign_code}" method="post">
	<table width="100%" class="innertable" border="0" cellspacing="0" cellpadding="0">
		<thead>
		<tr>			
			<th>Name</th>
...
function getcontacts() {
	...
	if(category !=  '') {
		if(confirm('Are you sure you want to add this category?')) {
			$.ajax({
				type: "GET",
				url: "mail.php?code={/literal}{$campaignData._campaign_code}{literal}",
